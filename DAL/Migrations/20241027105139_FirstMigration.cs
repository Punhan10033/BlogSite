        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AboutdDetails = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AboutdDetails2 = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReceieverId = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UserReceieverMessageId = table.Column<int>(type: "int", nullable: false),
                    UserSenderMessageId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MessageMessage", x => new { x.UserReceieverMessageId, x.UserSenderMessageId });
                    table.ForeignKey(
                        name: "FK_MessageMessage_Messages_UserReceieverMessageId",
                        column: x => x.UserReceieverMessageId,
                        principalTable: "Messages",
                        principalColumn: "MessageId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MessageMessage_Messages_UserSenderMessageId",
                        column: x => x.UserSenderMessageId,
                        principalTable: "Messages",
                        principalColumn: "MessageId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserReceieverId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserAuthentication", x => x.AuthenticationId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MessageMessage_UserSenderMessageId",
                table: "MessageMessage",
                column: "UserSenderMessageId");
